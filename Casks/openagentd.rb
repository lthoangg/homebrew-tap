cask "openagentd" do
  version "1.22.8"
  sha256 "be0e5f3bdfde5c7fa9a4875019cd44c92d8c6321eb3f7f111ed379d26ccc16cd"

  url "https://github.com/lthoangg/openagentd/releases/download/v1.22.8/OpenAgentd_1.22.8_aarch64.dmg"
  name "OpenAgentd"
