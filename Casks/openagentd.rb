cask "openagentd" do
  version "1.44.8"
  sha256 "7b75617ae463b0538bd2b36469049493319f57509344b50ba913fff48f0fc97a"

  url "https://github.com/lthoangg/openagentd/releases/download/v1.44.8/OpenAgentd_1.44.8_aarch64.dmg"
  name "OpenAgentd"
